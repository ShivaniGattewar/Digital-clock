...
#lb_dt = Label(clk,text="date" ,font = ("Times 20 bold",70,'bold'),bg="#9F0646",fg="white")
#lb_dt.place(x=100,y=50,width=150,height=150)

#lb_dt_txt = Label(clk,text="Date",font=("Times 20 bold",20,"bold"),bg="#9F0696",fg="white")
#lb_dt_txt.place(x=100,y=220,width=150,height=50)
